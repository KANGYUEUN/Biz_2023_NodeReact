 ...
 *  HTML tag 를 생성한은 코드를 return 하는 함수를
 * React 해서는 Component 라고 한다.
 *
 */
...
const Input = () => {
   ...
   * 새로생성된 배열에 nation 문자열을 추가하고
   * 새로 생성된 배열을 setNations() 함수를 통해 기존의 배열과 교체하라
   */
  return (
    <div>
