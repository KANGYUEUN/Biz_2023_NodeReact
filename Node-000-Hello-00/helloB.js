/**
 * JS의 배열은 데이터 형이 여러가지 섞여 잇어도 가능하다.
 * Java 에서의 배열은 반드시 같은 데이터 형만 가능하다.
 */
...
// 배열 복사 하는 방법
/**
 * 얕은 복사, 배열의 주소만 복사되어 원본과 복사본 배열이 동일한 배열이 된다.
 * 만약 복사본 배열 요소중 값이 변경되면 원본도 같이 변경된다.
 */
const arrayValue1 = arrayValue;

/**
 * < 전개연산자 ( Spread operation) > 를 이용한 깊은 복사
 * 배열의 요소 값 한개 한개들 일일이 모두 복사하는 법.
